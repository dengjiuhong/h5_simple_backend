...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?7e895e6e06e53807e8b2f7f1210bd3fa";
...
function wx_process() {
  wx.ready(function () {
    wx.onMenuShareTimeline({
      ...
      link: 'http://wx.oppo.com/oppootherfirm10/my_museum?name=' + encodeURI(user_name) + '&museum=' + panorama + '&time=' + user_time + '&id=' + user_id + '&code=' + $("#wx_code").val(), // 分享链接
      imgUrl: "http://oppo10.nplusgroup.net/image/500px.jpg", // 分享图标
      success: function () {
        // 用户确认分享后执行的回调函数
      },
